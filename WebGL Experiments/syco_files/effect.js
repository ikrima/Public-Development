...
Effect.prototype.Paint = function (time, mouseOriX, mouseOriY, mousePosX, mousePosY) {
    ...
    var l5 = gl.getUniformLocation(this.mProgram, "colorMask")
    var l6 = gl.getUniformLocation(this.mProgram, "colorTarget");
    var l7 = gl.getUniformLocation(this.mProgram, "threshold");
    ...
    var rgbfloatColorTarget = hex2rgb(parseInt(window.opener.colorTarget.value, 16));
    var rgbfloatColorMask = hex2rgb(parseInt(window.opener.colorMask.value,16));
    ...
    if (l7 != null) gl.uniform1f(l7, window.opener.thresholdField.value / 255.); //threshhold
    if (l6 != null) gl.uniform4f(l6, rgbfloatColorTarget.R, rgbfloatColorTarget.G, rgbfloatColorTarget.B, window.opener.transparencyLevel.value / 255.); //colorTarget
    if (l5 != null) gl.uniform3f(l5, rgbfloatColorMask.R, rgbfloatColorMask.G, rgbfloatColorMask.B); //colorMask
